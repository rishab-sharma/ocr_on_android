...
public class SignatureActivity extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            if (v == mClear) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    Toast.makeText(getApplicationContext(), "Successfully Saved" + StoredPath, Toast.LENGTH_LONG).show();
                ...
                userCall.enqueue(new Callback<ResultData>() {
                    ...
                    public void onResponse(Call<ResultData> call, Response<ResultData> response) {
                       ...
                       ResultData res = response.body();
                        ...
                        Intent intent = new Intent(SignatureActivity.this  , ResultActivity.class);

                        intent.putExtra("Result", res.getImage());
    ...
    private String encodeImage(Bitmap bm)
    {
        ...
        String encImage = Base64.encodeToString(b, Base64.DEFAULT).trim();
